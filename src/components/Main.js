...
// Updated Main to have: 
  ...
  // Return JSX:
      ...
      // Inside JSX, the `Routes` and `Route` components are used to define routing for different URLs. When the URL matches a specified path, it renders the corresponding element. (index and show components)
  // Export component:
      // export default Main: makes the `Main` component available for other parts of your application to import use. 
